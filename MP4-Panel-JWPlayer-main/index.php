	  	...
	  	<div class="row-fluid">
	  		<div class="col-sm-offset-2 col-md-offset-4 col-sm-8 col-md-4 col-xs-12 login-form">
	  			<div class="row-fluid">
	  				...
	  				<h2 style="text-align:center">Encriptar MP4</h2>
	  				</div>
	  			</div>
	  			<div class="row-fluid">
	  				<div class="col-sm-12">
	...
	<div class="container">
		<form id="action-form" action="action.php" method="POST" accept-charset="utf-8">
			...
			<div class="form-group">
				...
				<input type="text" name="link" class="form-control" placeholder="Ex: https://sample/Sintel.mp4"this.select()" required>
			</div>
						...
						<div class="row">
						    <div class="col-md-7">
						        <div class="form-group">
						        	...
						        	<input type="text" class="form-control" name="sub[0]" placeholder="Ex: https://demo/compuphd.srt (optional)" onclick="this.select()"> 
						        </div>
						    </div>
